                    ...
                    <button
                      onClick={() =>
                        setSelectedRecruiterForDetail({
                          ...
                          dailyTarget: 4,
                          todaySubmitted: 3,
                          monthlySubmitted: member.totalSubmissions,
                          submissions: member.totalSubmissions,
                          tatDays: member.avgTatDays,
                          clientsCount: member.assignedClients.length,
                          status: 'Active',
                          requirementsList: [
                            { id: 'REQ-101', title: 'Senior Full Stack Java Engineer', client: 'Accenture', targetDate: '2026-08-30', candidatesCount: 8, status: 'In Progress' },
                            { id: 'REQ-102', title: 'DevOps & AWS Cloud Architect', client: 'Goldman Sachs', targetDate: '2026-08-28', candidatesCount: 6, status: 'In Progress' },
                            { id: 'REQ-103', title: 'Embedded AUTOSAR C++ Engineer', client: 'LTTS Automotive', targetDate: '2026-08-25', candidatesCount: 5, status: 'In Progress' },
                          ],
                        })
                      }
